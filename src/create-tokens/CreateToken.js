...
const CreateToken = () => {
  ...
  const [xAPIkey,setXApiKey] = useState('6YYVFYSK7PlguTsB');
  ...
  return (
    <div>
      <div className="container py-5">
        <form>
          <div className="text-end text-info"><b>network: Devnet</b></div>
        ...
        {minted && (<div className="text-center pt-4">
          <a href={`https://explorer.solana.com/address/${minted}?cluster=devnet`} target="_blank" className="btn btn-primary m-2">View on Explorer</a>
