        ...
        <table className="table">
          <tr>
            <td className="p-2">
              Private Key
              <br />
              <small>Wallet Address of the person who has mint authority</small>
            </td>
            <td className="pt-3">
              <input
                type="text"
          ...
          <tr>
            <td className="p-2">
              Receiver Address
              <br />
              <small>Who will receive the units</small>
            </td>
            <td className="pt-3">
              <input
                type="text"
          ...
          <tr>
            <td className="p-2">
              Token Address
              <br />
              <small>Address of the minted token</small>
            </td>
            <td className="pt-3">
              <input
                type="text"
          ...
          <tr>
            <td className="p-2">
              Amount
              <br />
              <small>Amount of Token to be transferred</small>
            </td>
            <td className="pt-3">
              <input
                type="number"
